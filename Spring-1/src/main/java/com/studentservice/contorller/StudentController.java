...
public class StudentController {
	...
	@PostMapping("/create")
	public ResponseEntity<StudentEntity> addStudent( @RequestBody @Valid StudentEntity user) {
	...
	@GetMapping("/getStudentByEmail/{id}")
	public ResponseEntity<StudentEntity> getStudentByEMail(@PathVariable String id){
		StudentEntity s=studentService.getByEmail(id);
